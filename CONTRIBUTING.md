...
Please start a discussion on the [core repo issue tracker](https://github.com/imperugo/StackExchange.Redis.Extensions/issues).

## Building

Run `build.bat` or `build.sh` if you are running on OSX/Linux from the command line. This builds and runs tests.

## Bugs and feature requests?
Please log a new issue in the appropriate GitHub repo:

* [Core](https://github.com/imperugo/StackExchange.Redis.Extensions)
* [Documentation](https://imperugo.gitbook.io/stackexchange-redis-extensions/)
...
1. Did you read the [documentation](https://imperugo.gitbook.io/stackexchange-redis-extensions/)?
